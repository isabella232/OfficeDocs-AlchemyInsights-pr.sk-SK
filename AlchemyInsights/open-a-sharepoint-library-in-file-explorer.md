...
ms.locfileid: "30759417"
---
# <a name="open-a-sharepoint-library-in-file-explorer"></a>Otvorenie knižnice v programe Prieskumník

1. Prejdite do knižnice v Internet Explorer 10 alebo Internet Explorer 11. 
    
2. Kliknite na ikonu zobrazenie v pravom hornom rohu a potom kliknite na **zobrazenie v Prieskumníkovi**.
