...
ms.locfileid: "29757603"
---
# <a name="install-skype-for-business"></a><span data-ttu-id="64491-102">Inštalácia Skypu for Business</span><span class="sxs-lookup"><span data-stu-id="64491-102">Install Skype for Business</span></span>

<span data-ttu-id="64491-103">Skype for Business môžete nainštalovať podľa nasledujúcich krokov v tomto článku: [Nainštalujte Skype pre podniky](https://support.office.com/article/Install-Skype-for-Business-8a0d4da8-9d58-44f9-9759-5c8f340cb3fb.aspx)</span><span class="sxs-lookup"><span data-stu-id="64491-103">You can install Skype for Business by following the steps in this article: [Install Skype for Business](https://support.office.com/article/Install-Skype-for-Business-8a0d4da8-9d58-44f9-9759-5c8f340cb3fb.aspx)</span></span>
