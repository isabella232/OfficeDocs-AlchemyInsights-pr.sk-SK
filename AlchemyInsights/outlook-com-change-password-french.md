...
1. Accédez à [https://account.microsoft.com/security](https://go.microsoft.com/fwlink/p/?linkid=842325&amp;clcid=0x409) et l **sécurité du MOT de Passe**.
2. Par mesure de sécurité, vous pouvez être invité à confirmer votre identité à l ' aide d ' un code de sécurité.
3. Entrez votre MOT de Passe Actuel, votre Nouveau MOT de Passe, puis l **enregistrer**.

Si vous avez oublié votre MOT de Passe, accédez à la [Page de réinitialisation de MOT de Passe de Compte Microsoft](https://go.microsoft.com/fwlink/p/?linkid=841909), puis suivez Les pozýva.
