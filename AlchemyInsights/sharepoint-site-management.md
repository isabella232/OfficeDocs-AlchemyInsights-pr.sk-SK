...
---
# <a name="sharepoint-online-site-management"></a>Správa lokality SharePointOnline

Tu sú niektoré často požadované témy pre správu lokality SharePoint Online:

- [Správa lokalít](https://docs.microsoft.com/sharepoint/manage-sites-in-new-admin-center)
- [Správa obmedzení ukladacieho priestoru lokality](https://docs.microsoft.com/sharepoint/manage-site-collection-storage-limits)
