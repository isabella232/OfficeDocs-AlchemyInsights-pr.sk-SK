...
---
# <a name="sharing-and-permission-methods-to-provide-or-restrict-user-access-to-sharepoint-site"></a>Spôsoby zdieľania a povolenia na poskytovanie alebo obmedzenie prístupu používateľa na lokalitu SharePoint

Po vytvorení lokality SharePoint možno budete chcieť poskytnúť alebo obmedziť prístup používateľa na lokalitu alebo jej obsah. To možno vykonať prostredníctvom rôznych spôsobov zdieľania a povolenia uvedené nižšie.
...
- [Zmena predvoleného typu prepojenia, keď používatelia získajú prepojenia na zdieľanie](https://docs.microsoft.com/sharepoint/change-default-sharing-link)
