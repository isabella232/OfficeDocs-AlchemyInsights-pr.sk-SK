...
[Obnovenie odstránených OneDrive stránky](https://docs.microsoft.com/en-us/onedrive/restore-deleted-onedrive)

Pre hromadné recycle bin akcie, admini zvážiť použitie [Sharepoint Online PNP](https://docs.microsoft.com/en-us/powershell/sharepoint/sharepoint-pnp/sharepoint-pnp-cmdlets?view=sharepoint-ps).

## <a name="files-restore-feature"></a>Funkcia obnoviť súbory
