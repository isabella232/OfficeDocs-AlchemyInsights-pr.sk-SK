...
3. Vyberte položku **aktivovať**.
    ...
    Ak nevidíte **aktivovať** ako možnosť, použite možnosť "Dajte nám zavolať" hovoriť pracovník technickej podpory Opätovná aktivácia prihlásenia na odber. 
    
4. Opätovná aktivácia, zobrazí výzva aktualizujte svoje platobné údaje. Zadajte svoje platobné údaje a vyberte **Odoslať**.
