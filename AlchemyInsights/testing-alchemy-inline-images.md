---
title: Testovanie inline obrázkov alchýmie
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "44505070"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="8db3a-102">Prístup na stránku Domény</span><span class="sxs-lookup"><span data-stu-id="8db3a-102">Access the Domains Page</span></span>

<span data-ttu-id="8db3a-103">Ak chcete získať prístup k doménam stránku, stačí kliknúť na túto ikonu nižšie:</span><span class="sxs-lookup"><span data-stu-id="8db3a-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="8db3a-104">Potom môžete pridať, upraviť alebo odstrániť svoju doménu.</span><span class="sxs-lookup"><span data-stu-id="8db3a-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="8db3a-105">Ďalšie informácie nájdete v [téme Najčastejšie otázky o doménach.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="8db3a-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
