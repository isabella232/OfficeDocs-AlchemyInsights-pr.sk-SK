...
---
# <a name="access-the-domains-page"></a>Prístup na stránku domény

Ak chcete získať prístup k stránke domény, stačí kliknúť na túto ikonu:
...
Potom môžete pridať, upraviť alebo odstrániť doménu.
Ďalšie informácie nájdete v časti [najčastejšie otázky o doménach.](https://docs.microsoft.com/office365/admin/setup/domains-faq)
