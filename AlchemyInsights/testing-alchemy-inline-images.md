...
ms.locfileid: "36507178"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="e2bf4-102">Prístup k stránke domény</span><span class="sxs-lookup"><span data-stu-id="e2bf4-102">Access the Domains Page</span></span>

<span data-ttu-id="e2bf4-103">Pre sprístupnenie stránky na doménach, len kliknutím na túto ikonu nižšie:</span><span class="sxs-lookup"><span data-stu-id="e2bf4-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="e2bf4-104">Potom môžete pridať, upraviť alebo odstrániť domény.</span><span class="sxs-lookup"><span data-stu-id="e2bf4-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="e2bf4-105">Ďalšie informácie nájdete v [domény FAQ.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span><span class="sxs-lookup"><span data-stu-id="e2bf4-105">For more information, see the [Domains FAQ.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span></span>
