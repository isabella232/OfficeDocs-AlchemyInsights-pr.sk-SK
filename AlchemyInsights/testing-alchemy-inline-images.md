---
title: Testovanie alchýmie vnorených obrázkov
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="d22ae-102">Prístup k stránke domény</span><span class="sxs-lookup"><span data-stu-id="d22ae-102">Access the Domains Page</span></span>

<span data-ttu-id="d22ae-103">Ak chcete získať prístup k stránke Domains (domény), stačí kliknúť na túto ikonu nižšie:</span><span class="sxs-lookup"><span data-stu-id="d22ae-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="d22ae-104">Potom môžete pridať, upraviť alebo odstrániť svoju doménu.</span><span class="sxs-lookup"><span data-stu-id="d22ae-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="d22ae-105">Ďalšie informácie nájdete v téme [najčastejšie otázky o doménach.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="d22ae-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
