...
3. [Naučte sa zapísať macOS zariadení Microsoft Intune](https://docs.microsoft.com/en-us/intune/macos-enroll).
    
[Pozrite si príručku koncového používateľa prihlásiť macOS zariadení Microsoft Intune](https://docs.microsoft.com/en-us/intune-user-help/enroll-your-device-in-intune-macos-cp)
