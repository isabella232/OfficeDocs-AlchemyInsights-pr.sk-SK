---
title: Importovanie kontaktov na Outlook.com
ms.author: daeite
author: daeite
manager: joallard
ms.date: 04/21/2020
...
ms.locfileid: "53962218"
---
# <a name="import-contacts"></a>Importovanie kontaktov

Pred importom kontaktov na Outlook.com ich musíte exportovať od iného poskytovateľa e-mailových služieb ako .csv súbor. Potom postupujte podľa pokynov uvedených nižšie.
...
.
2. V hornej časti stránky vyberte položku **Spravovať** \> **import kontaktov**.
3. Vyberte **položku Prehľadávať**, prejdite do priečinka, kam ste uložili exportované kontakty, a vyberte položku **Otvoriť**.
