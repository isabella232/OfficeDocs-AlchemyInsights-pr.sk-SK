...
1. Otvorená **Moderná Admin Center** - Ak ste klasickej Admin Center budete vidieť **skúste to teraz** alebo **náhľad** tlačidlo v pravom hornom. Tým sa dostanete do modernej Admin Center. 
  
2. Vyberte **aktívnymi lokalitami**. 
  
3. Vyberte stránku, ktorá má šablóny **Tímovej lokality** . 
